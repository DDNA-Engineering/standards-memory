...
[Quickstart](#run-the-portable-synthetic-starter) · [Prepared corpus](#query-the-prebuilt-corpus) · [Library snapshot](#complete-prepared-library-snapshot) · [Commands](#six-ways-to-read) · [Architecture](#under-the-hood) · [Roadmap](#where-this-is-going) · [Contributing](CONTRIBUTING.md)
