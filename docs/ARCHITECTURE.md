...
- `mcp_server`: local stdio adapter exposing exactly the seven read operations under a startup-bound principal, with no administration, listener, or telemetry middleware.
